...
$dbh->execute("select comment from accounts", db_postgres::USER_CACHE_LINE);
$dbh->execute("select pword from accounts");
$dbh->execute("insert into accounts values('test', 'test_pass', 6, 'test_comment')", db_postgres::USER_CACHE_LINE);
//$dbh->print_cache();
